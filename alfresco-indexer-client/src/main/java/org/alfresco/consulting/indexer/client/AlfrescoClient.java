...
public interface AlfrescoClient {
    /**
     * Fetches nodes from Alfresco which has changed since the provided
     * timestamp.
     *
     * @param lastAclChangesetId
     *            the id of the last ACL changeset already being indexed; it can
     *            be considered a "startFrom" param
     * @param lastTransactionId
     *            the id of the last transaction already being indexed; it can
     *            be considered a "startFrom" param
     * @return an {@link AlfrescoResponse}
     */
    AlfrescoResponse fetchEvents(long lastTransactionId, long lastAclChangesetId, long maxTransactionId,
            long maxLastAclChangesetId) throws AlfrescoDownException;
     ...
     * @return an {@link AlfrescoResponse}
     */
    AlfrescoResponse fetchNodes(long lastTransactionId, long lastAclChangesetId) throws AlfrescoDownException;
    ...
    /**
     * Fetches all child nodes given a specific path
     * @param path
     * @return
     */
    AlfrescoResponse fetchDocuments(String path, long fromIndex, long toIndex);
}
